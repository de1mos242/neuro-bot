...
from tensorflow.python.keras.layers import TimeDistributed, Flatten, Activation, RepeatVector, Permute, \
    Lambda, multiply
...
filepath="weights-improvement-1K-1024-{epoch:02d}-{val_loss:.2f}.hdf5"
